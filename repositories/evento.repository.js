...
let EventoRepository = class EventoRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Evento, dataSource);
    }
};
EventoRepository = tslib_1.__decorate([
